                        ...
                        <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                            ...
                            <div class="menu-item">
                                <div class="menu-content pb-2">
                                    <span class="menu-section text-muted text-uppercase fs-8 ls-1">Dashboard2</span>
                                </div>
                            </div>
                            <div class="menu-item">
                                <a class="menu-link active" href="{{ route('dashboard') }}">
                                    ...
                                    <span class="menu-title">Halaman Dashboard</span>
                                </a>
                            </div>
                            <div class="menu-item">
                            ...
                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                <span class="menu-link">
                                    ...
                                    <span class="menu-title">Konfigurasi User</span>
                                    <span class="menu-arrow"></span>
                                </span>
                                <div class="menu-sub menu-sub-accordion menu-active-bg">
                                    <div class="menu-item">
                                    ...
                                    <div class="menu-item">
                                     ...
                                     {{-- <div class="menu-item">
                                        <a class="menu-link" href="{{ route('user-pptk.index') }}">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                                            <span class="menu-title">User PPTK</span>
                                        </a>
                                    </div> --}}
                                    <div class="menu-item">
                                        <a class="menu-link" href="{{ route('fases.index') }}">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link" href="{{ route('official-roles.index') }}"><span class="menu-bullet"><span class="bullet bullet-dot"></span></span><span class="menu-title">Official Role</span></a>
                                    </div>
                                    <div class="menu-item">
                                        <a class="menu-link" href="{{ route('master.position-assignments.index') }}"><span class="menu-bullet"><span class="bullet bullet-dot"></span></span><span class="menu-title">Position Assignment</span></a>
                                    </div>
                                    <div class="menu-item">
                                        <a class="menu-link" href="{{ route('master.position-delegations.index') }}"><span class="menu-bullet"><span class="bullet bullet-dot"></span></span><span class="menu-title">Position Delegation</span></a>
                                    </div>
                                    <div class="menu-item">
                                        <a class="menu-link" href="{{ route('master.position-hierarchies.index') }}"><span class="menu-bullet"><span class="bullet bullet-dot"></span></span><span class="menu-title">Position Hierarchy</span></a>
                                    </div>
                                </div>
                            </div>
                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                ...
                                <div class="menu-sub menu-sub-accordion menu-active-bg">
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        <span class="menu-link">
                                            ...
                                            <span class="menu-title">Setting Input</span>
                                            <span class="menu-arrow"></span>
                                        </span>
                                        <div class="menu-sub menu-sub-accordion menu-active-bg">
                                            <div class="menu-item">
                                                <a class="menu-link"
                                                    href="{{ route('tahun_anggarans.index') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Tahun Anggaran</span>
                                                </a>
                                            </div>
                                            <div class="menu-item">
                                                <a class="menu-link"
                                            ...
                                            <div class="menu-item">
                                                <a class="menu-link"
                                                    href="{{ route('uraian_satus.index') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Uraian 1</span>
                                                </a>
                                            </div>
                                             <div class="menu-item">
                                                <a class="menu-link"
                                                    href="{{ route('uraian_duas.index') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Uraian 2</span>
                                                </a>
                                            </div>
                                            <div class="menu-item">
                                                <a class="menu-link"
                                                    href="{{ route('ppns.index') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">PPN</span>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        <span class="menu-link">
                                            ...
                                            <span class="menu-title">Setting RKBU</span>
                                            <span class="menu-arrow"></span>
                                        </span>
                                        <div class="menu-sub menu-sub-accordion menu-active-bg">
                                            <div class="menu-item">
                                            ...
                                            <div class="menu-item">
                                                <a class="menu-link"
                                                    href="{{ route('jenis_belanjas.index') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Jenis Belanja</span>
                                                </a>
                                            </div>
                                            <div class="menu-item">
                                                <a class="menu-link"
                                                    href="{{ route('jenis_kategori_rkbus.index') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Jenis Kategori RKBU</span>
                                                </a>
                                            </div>
                                            <div class="menu-item">
                                                <a class="menu-link"
                                            ...
                                            <div class="menu-item">
                                                <a class="menu-link"
                                                    href="{{ route('sub_kegiatans.index') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                             ...
                                             <div class="menu-item">
                                                <a class="menu-link"
                                                    href="{{ route('kategori_rekenings.index') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Kategori Rekening</span>
                                                </a>
                                            </div>
                                             <div class="menu-item">
                                                <a class="menu-link"
                                                    href="{{ route('obyek_belanjas.index') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Obyek Belanja</span>
                                                </a>
                                            </div>
                                             <div class="menu-item">
                                                <a class="menu-link"
                                                    href="{{ route('kategori_rkbus.index') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Kategori RKBU</span>
                                                </a>
                                            </div>
                                             <div class="menu-item">
                                                <a class="menu-link"
                                                    href="{{ route('sumber_danas.index') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                            ...
                                            <div class="menu-item">
                                                <a class="menu-link"
                                                    href="{{ route('rekening_belanjas.index') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Rekening Belanja</span>
                                                </a>
                                            </div>
                                             <div class="menu-item">
                                                <a class="menu-link"
                                                    href="{{ route('sub_kategori_rekenings.index') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Sub Kategori Rekening</span>
                                                </a>
                                            </div>
                                            <div class="menu-item">
                                                <a class="menu-link"
                                                    href="{{ route('sub_kategori_rkbus.index') }}">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Sub Kategori RKBU</span>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                <span class="menu-link">
                                    ...
                                    <span class="menu-title">Work Flow Setting</span>
                                    <span class="menu-arrow"></span>
                                </span>
                                <div class="menu-sub menu-sub-accordion menu-active-bg">
                                    <div class="menu-item">
                                    ...
                                    <div class="menu-item">
                                        <a class="menu-link" href="
                                        {{-- {{ route('workflow_steps.index') }} --}}
                                         ">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                                            <span class="menu-title">Workflow Step</span>
                                        </a>
                                    </div>
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        <span class="menu-link">
                                            ...
                                            <span class="menu-title">Roles Sub Kategori</span>
                                            <span class="menu-arrow"></span>
                                        </span>
                                        <div class="menu-sub menu-sub-accordion">
                                            <div class="menu-item">
                                        <a class="menu-link" href="
                                        {{-- {{ route('workflow-step-sub-kategori-rkbu.index') }} --}}
                                         ">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                                            <span class="menu-title">Workflow Step Sub Kategori RKBU</span>
                                        </a>
                                    </div>
                                    {{-- <div class="menu-item">
                                        <a class="menu-link" href="{{ route('workflow_step_pptks.index') }}">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                                            <span class="menu-title">Workflow Step PPTK</span>
                                        </a>
                                    </div> --}}
                                    <div class="menu-item">
                                        <a class="menu-link" href="
                                        {{-- {{ route('position_sub_kategori_rkbu.index') }} --}}
                                         ">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                                            <span class="menu-title">Position Sub Kategori RKBU</span>
                                        </a>
                                    </div>
                                        </div>
                                    </div>
                                    <div class="menu-item">
                                     ...
                                     {{-- <div class="menu-item">
                                        <a class="menu-link" href="{{ route('pptk_kategori.index') }}">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                                            <span class="menu-title">PPTK Kategori</span>
                                        </a>
                                    </div> --}}
                                </div>
                            </div>
                                ...
                                <div class="menu-sub menu-sub-accordion">
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion mb-1">
                                        <span class="menu-link">
                                            ...
                                            <span class="menu-title">Users Validator</span>
                                            <span class="menu-arrow"></span>
                                        </span>
                                        <div class="menu-sub menu-sub-accordion">
                                            <div class="menu-item">
                                                <a class="menu-link"
                                                    href="
                                                    {{-- {{ route('validator-roles.index') }} --}}
                                                     ">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">Validator Roles</span>
                                                </a>
                                            </div>
                                              <div class="menu-item">
                                                <a class="menu-link"
                                                    href="
                                                    {{-- {{ route('user-validator-roles.index') }} --}}
                                                     ">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                                    <span class="menu-title">User Validator Roles</span>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                ...
                                <div class="menu-sub menu-sub-accordion">
                                    <div class="menu-item">
                                        {{-- <a class="menu-link"
                                            href="{{ route('rkbu.index') }}">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                                            <span class="menu-title">RKBU</span>
                                        </a> --}}
                                    </div>
                                    <div class="menu-item">
                                        {{-- <a class="menu-link" href="{{ route('rkbu.barjas.index') }}">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                                            <span class="menu-title">RKBU Barjas</span>
                                        </a> --}}
                                    </div>
                                    <div class="menu-item">
                            ...
                            <div class="menu-item">
                                <a class="menu-link"
                                    ...
                                    <span class="menu-title">Changelog v8.0.25sfsf</span>
                                </a>
                            </div>
                        </div>
                        <!--end::Menu-->
