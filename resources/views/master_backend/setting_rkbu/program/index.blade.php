...
@section('content')
    <div class="card mb-5 mb-xxl-12">
        <div class="card-body pt-9 pb-0">
            ...
            @include('master_backend.setting_rkbu.program.modal_add')
        </div>
    </div>
            ...
            <div class="card card-xl-stretch mb-5 mb-xl-8">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                                                    ...
                                                    <div class="d-flex align-items-center mb-3">
                                                        <div class="d-flex align-items-center flex-grow-1">
                                                            ...
                                                            <div class="d-flex flex-column">
                                                                <a href="#"
                                                                    class="text-gray-900 text-hover-primary fs-6 fw-bolder">{{ $item->kode_program }}. {{ $item->nama_program }}</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="mb-1">
                        ...
                        @include('master_backend.setting_rkbu.program.modal_edit')
                    </div>
                </div>
            </div>
        </div>
