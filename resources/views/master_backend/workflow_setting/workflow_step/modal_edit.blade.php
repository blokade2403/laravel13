 @foreach ($workflowSteps as $step)
     <div class="modal fade" id="kt_modal_new_target_form{{ $step->id }}" tabindex="-1" aria-hidden="true">
                 ...
                 <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                     <form id="kt_modal_new_target_form{{ $step->id }}"
                         ...
                         <div class="row g-9 mb-8">
                             <!--begin::Col-->
                             <div class="col-md-12 fv-row fv-plugins-icon-container">
                                 <label class="required fs-6 fw-bold mb-2">Validator</label>
                                 <select class="form-select" name="validator_role_id" data-control="select2"
                                     ...
                                     @foreach ($validatorRoles as $role)
                                         <option value="{{ $role->id }}"
                                             {{ $role->id == $step->validator_role_id ? 'selected' : '' }}>
                                             {{ $role->nama_validator }}
                                         </option>
                                     @endforeach
                                 </select>
                         ...
                         <div class="d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
                             ...
                             <input type="number" class="form-control form-control-solid" placeholder="Enter Urutan"
                                 name="step_order" value="{{ $step->step_order }}" required>
                             <div class="fv-plugins-message-container invalid-feedback"></div>
                         </div>
