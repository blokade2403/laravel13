...
@section('content')
    <div class="card mb-5 mb-xxl-12">
        <div class="card-body pt-9 pb-0">
            ...
            @include('master_backend.workflow_setting.workflow_step.modal_add')
        </div>
    </div>
                        ...
                        <table id="kt_customers_table"
                            ...
                            <thead>
                                <tr class="fw-bolder text-muted">
                                    ...
                                    <th class="min-w-120px">Required</th>
                                    <th class="min-w-120px">PPTK Step</th>
                                                    ...
                                                    <div class="d-flex align-items-center mb-3">
                                                        <div class="d-flex align-items-center flex-grow-1">
                                                            ...
                                                            <div class="d-flex flex-column">
                                                                <a href="#"
                                                                    class="text-gray-900 text-hover-primary fs-6 fw-bolder">{{ $item->workflow->nama_workflow ?? '-' }}</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="mb-1">
