    ...
    @section('content')
        <div class="card mb-5 mb-xxl-12">
            <div class="card-body pt-9 pb-0">
                ...
                @include('master_backend.workflow_setting.pptk_kategori.modal_add')
            </div>
        </div>
                            ...
                            <table id="kt_customers_table"
                                ...
                                <tbody>
                                    @php
                                        $no = 1;
                                    @endphp
                                    @foreach($pptkKategoris as $key => $item)
                                        <tr>
                                            <td>
                                                <div class="form-check form-check-sm form-check-custom form-check-solid">
                                                        ...
                                                        <div class="d-flex align-items-center mb-3">
                                                            <div class="d-flex align-items-center flex-grow-1">
                                                                ...
                                                                <div class="d-flex flex-column">
                                                                    <a href="#"
                                                                        class="text-gray-900 text-hover-primary fs-6 fw-bolder">{{ $item->nama_kategori }}</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="mb-1">
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-end flex-shrink-0">
                                                    ...
                                                    <form action="{{ route('pptk_kategori.destroy', $item->id) }}" method="POST"
