                                            ...
                                            <div class="row g-3">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea name="spek" class="form-control" id="VertimeassageInput" cols="3" rows="3">{{ old('spek') }}</textarea>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <select name="id_jenis_kategori_rkbu" class="form-select"
                                                            ...
                                                            <option value="" disabled
                                                                {{ old('id_jenis_kategori_rkbu' ?? '') == '' ? 'selected' : '' }}>
                                                                Pilih Kategori
                                                            </option>
                                                            @foreach ($jenis_kategori_rkbu as $item)
                                                                <option value="{{ $item->id_jenis_kategori_rkbu }}"
                                                                    {{ old('id_jenis_kategori_rkbu' ?? '') == $item->id_jenis_kategori_rkbu ? 'selected' : '' }}>
