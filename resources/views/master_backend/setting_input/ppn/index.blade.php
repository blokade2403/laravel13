...
@section('content')
    ...
    <div class="card mb-5 mb-xxl-12">
        <div class="card-body pt-9 pb-0">
            ...
            @include('master_backend.setting_input.ppn.modal_add')
            <!--begin::Details-->
            ...
            <div class="card card-xl-stretch mb-5 mb-xl-8">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                                    ...
                                    <tr>
                                                    ...
                                                    <div class="d-flex align-items-center mb-3">
                                                        <div class="d-flex align-items-center flex-grow-1">
                                                            ...
                                                            <div class="d-flex flex-column">
                                                                <a href="#"
                                                                    class="text-gray-900 text-hover-primary fs-6 fw-bolder">{{ $item->ppn }}</a>
                                                                <span
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-end flex-shrink-0">
                                                ...
                                                <form action="{{ route('ppns.destroy', $item->id) }}" method="POST"
                        ...
                        @include('master_backend.setting_input.ppn.modal_edit')
                        <!--end::Table-->
                    </div>
                    <!--end::Table container-->
                </div>
