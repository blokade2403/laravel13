            ...
            <div class="card card-xl-stretch mb-5 mb-xl-8">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="kt_customers_table"
                            ...
                            <thead>
                                <tr class="fw-bolder text-muted">
                                    ...
                                    <th class="min-w-150px">Name Unit</th>
                                    <th class="min-w-150px">Kode Unit</th>
                                    <th class="min-w-150px">Jenis Unit</th>
                                    <th class="min-w-150px">Parent Unit</th>
                            ...
                            <tbody>
                                ...
                                @foreach ($units as $item)
                                    <tr>
                                                    ...
                                                    <div class="d-flex align-items-center mb-3">
                                                        <div class="d-flex align-items-center flex-grow-1">
                                                            ...
                                                            <div class="d-flex flex-column">
                                                                <a href="#"
                                                                    class="text-gray-900 text-hover-primary fs-6 fw-bolder">{{ $item->nama_unit }}</a>
                                                                <span
                                        ...
                                        <td>{{ $item->parent?->kode_unit }}{{ $item->parent ? ' - '.$item->parent->nama_unit : '-' }}</td>
                                        <td>
                                            <div class="d-flex justify-content-end flex-shrink-0">
                                                ...
                                                <a href="#"
                                                    ...
                                                    data-bs-target="#modal_edit_unit_{{ $item->id }}">
                                                    <!--begin::Svg Icon-->
                                                    <span class="svg-icon svg-icon-3">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                            height="24" viewBox="0 0 24 24" fill="none">
                        ...
                        @include('master_backend.setting_users.unit.modal_edit')
                        <!--end::Table-->
                    </div>
                    <!--end::Table container-->
                </div>
