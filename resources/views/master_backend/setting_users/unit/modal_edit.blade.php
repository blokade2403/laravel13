 ...
 <div class="modal fade"  id="modal_edit_unit_{{ $item->id }}" tabindex="-1" aria-hidden="true">
     <div class="modal-dialog modal-dialog-centered mw-650px">
         <div class="modal-content rounded">
             ...
             <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                 <form class="form fv-plugins-bootstrap5 fv-plugins-framework form-submit"
                     action="{{ route('units.update', $item->id) }}" method="post">
                     @csrf
                     @method('PUT')
                     ...
                     <div class="d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
                         ...
                         <input type="text" class="form-control form-control-solid" placeholder="Enter Kode Unit" name="kode_unit" value="{{ $item->kode_unit }}" required>
                      ...
                      <div class="d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
                         ...
                         <input type="text" class="form-control form-control-solid" placeholder="Enter Nama Unit"
                             name="nama_unit" value="{{ $item->nama_unit }}" required>
                         <div class="fv-plugins-message-container invalid-feedback"></div>
                     </div>
                      <div class="d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
                         <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                         ...
                         <input type="text" class="form-control form-control-solid" placeholder="Enter Jenis Unit"
                             name="jenis_unit" value="{{ $item->jenis_unit }}" required>
                         <div class="fv-plugins-message-container invalid-feedback"></div>
                     </div>
