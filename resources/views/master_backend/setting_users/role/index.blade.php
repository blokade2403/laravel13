            ...
            <div class="card card-xl-stretch mb-5 mb-xl-8">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="kt_customers_table"
                            ...
                            <thead>
                                <tr class="fw-bolder text-muted">
                                    ...
                                    <th class="min-w-150px">Name Role</th>
                                    <th class="min-w-100px">Kode Role</th>
                                                    ...
                                                    <div class="d-flex align-items-center mb-3">
                                                        <div class="d-flex align-items-center flex-grow-1">
                                                            ...
                                                            <div class="d-flex flex-column">
                                                                <a href="#"
                                                                    class="text-gray-900 text-hover-primary fs-6 fw-bolder">{{ $item->nama_role }}</a>
                                                                <span
                        ...
                        @include('master_backend.setting_users.role.modal_edit')
                        <!--end::Table-->
                    </div>
                    <!--end::Table container-->
                </div>
