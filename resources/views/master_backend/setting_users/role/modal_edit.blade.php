         ...
         <div class="modal-content rounded">
             ...
             <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                 <form class="form fv-plugins-bootstrap5 fv-plugins-framework form-submit"
                     action="{{ route('roles.update', $item->id) }}" method="post">
                     @csrf
                     @method('PUT')
                     <div class="mb-13 text-center">
                         <h1 class="mb-3">Set Edit Data</h1>
                         <div class="text-muted fw-bold fs-5">Edit Data Role.
                         </div>
                     </div>
                     <div class="row g-9 mb-8">
                         ...
                         <div class="col-md-6 fv-row fv-plugins-icon-container">
                             ...
                             <input type="text" class="form-control form-control-solid" placeholder="Enter Kode Role"
                                 name="kode_role" value="{{ $item->kode_role }}" required>
                         ...
                         <div class="col-md-6 fv-row">
                             ...
                             <div class="position-relative d-flex align-items-center">
                                 <input class="form-control form-control-solid" placeholder="Enter Nama Role" name="nama_role"
                                     type="text" value="{{ $item->nama_role }}" required>
                             </div>
                             <!--end::Input-->
                         </div>
                         <!--end::Col-->
                     ...
                     <div class="d-flex flex-column mb-8 fv-row">
                         ...
                         <textarea class="form-control form-control-solid" name="deskripsi">{{ $item->deskripsi }}</textarea>
                     </div>
