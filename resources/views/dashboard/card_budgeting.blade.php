<div class="row g-5 g-xl-8">
    ...
    <a href="#" class="card bg-danger hoverable mb-4" style="height: 120px;">
        <!--begin::Body-->
        <div class="card-body p-3">
            ...
            <!-- Text -->
            <div class="text-white fw-bolder fs-4 mt-3">
                500M$
            </div>

            <div class="fw-bold text-white fs-7">
                SAP UI Progress
            </div>
    ...
    <div class="col-xl-3">
    <!--begin::Statistics Widget 5-->
    <a href="#" class="card bg-primary hoverable mb-4" style="height: 120px;">
        <!--begin::Body-->
        <div class="card-body p-3">
